...
test('groupByWeek: summiert TSS/Dauer und zaehlt Einheiten je Sportart pro ISO-Woche, neueste zuerst', () => {
  const activities = [
    { date: '2026-09-14', type: 'Ride', tss: 50, movingTimeSec: 3600 },
    { date: '2026-09-16', type: 'Ride', tss: 30, movingTimeSec: 1800 },
    { date: '2026-09-20', type: 'Run', tss: 40, movingTimeSec: 2400 },
    { date: '2026-09-21', type: 'Ride', tss: 60, movingTimeSec: 5400 }, // naechste Woche (Montag 21.)
  ];
